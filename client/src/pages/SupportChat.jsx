  ...
  return (
    ...
    >
      <div className="page-container py-6">
        ...
        >
          <div
            className={`flex items-center gap-3 px-5 py-4 border-b border-gray-100 dark:border-dark-border ${isRTL ? 'flex-row-reverse' : ''}`}
          >
            <div className="relative">
              ...
              <div
                className={`absolute -bottom-0.5 ${isRTL ? '-left-0.5' : '-right-0.5'} w-3 h-3 bg-emerald-400 rounded-full border-2 border-white dark:border-dark-surface`}
              />
            </div>
            ...
            {messages.map((msg) => (
              ...
              >
                ...
                >
                  {msg.isCard ? (
                    <div
                      className={`bg-brand-cream dark:bg-dark-bg border border-brand-gold/30 dark:border-brand-gold/50 rounded-2xl p-4 text-sm ${isRTL ? 'text-right' : 'text-left'}`}
                    >
          ...
          <div
            className={`px-5 py-2 flex gap-2 overflow-x-auto ${isRTL ? 'flex-row-reverse' : ''}`}
          >
          ...
          <div className="px-4 pb-4 pt-2">
            <div
              className={`flex items-center gap-2 bg-gray-50 dark:bg-dark-bg rounded-2xl p-1 border border-gray-200 dark:border-dark-border focus-within:border-brand-navy dark:focus-within:border-brand-gold focus-within:bg-white dark:focus-within:bg-dark-surface transition-all ${isRTL ? 'flex-row-reverse' : ''}`}
            >
              <button
                type="button"
